sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.trackSalesOrder.controller.ProductList", {
		handleRouteMatched: function(oEvent) {
			...
			if (oEvent.mParameters.data.context || oEvent.mParameters.data.masterContext) {
				...
				if (this.sMasterContext) {
					...
					this._attachSelectListItemWithContextPath(sCurrentContextPath);
		...
		_onButtonPress4: function(oEvent) {
			...
			var sDialogName = "D0_1463750005259";
